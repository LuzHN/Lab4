	...
	while (resp == 's'){
		...
		if (opcion==7) {
			...
			for (int i = 0; i < 3; ++i){
				for (int j = 0; j < 3; ++j){
					if(i == 0){
						arrsuperior[cont] = matriz4[i][j];
						cont++;
					}
					else if(i == 1){
						arrmedio[cont] = matriz4[i][j];
						cont++;
					}
					else if(i == 2){
						arrinferior[cont] = matriz4[i][j];
						cont++;
					}
				}
				cont = 0;
			...
			for (int i = 0; i < 3; ++i){
				for (int j = 0; j < 3; ++j){
					if(j == 0){
						matriz4[i][j] = arrinferior[cont];
						cont++;
					}
					else if(j == 1){
						matriz4[i][j] = arrmedio[cont];
						cont++;
					}
					else if(j == 2){
						matriz4[i][j] = arrsuperior[cont];
						cont++;
					}
		...
		if (opcion==9) {
			...
			for (int h = 0; h <= 4; ++h){
				for (int i = 0; i < 3; ++i){
					for (int j = 0; j < 3; ++j){
						if(h == 1){
							if(j == 0){
								matriz2[i][j] = arrarriba[cont];
								cont++;
							}
						}
						else if(h == 2){
							if(i == 0){
								matriz4[i][j] = arratras[cont];
								cont++;
							}
						}
						else if(h == 3){
							if(j == 2){
								matriz1[i][j] = arrabajo[cont];
								cont++;
							}
						}
						else if(h == 4){
							if(i == 2){
								matriz3[i][j] = arrfrente[cont];
								cont++;
							}
						}
					}
			...
			for (int i = 0; i < 3; ++i){
				for (int j = 0; j < 3; ++j){
					if(i == 0){
						arrsuperior[cont] = matriz5[i][j];
						cont++;
					}
					else if(i == 1){
						arrmedio[cont] = matriz5[i][j];
						cont++;
					}
					else if(i == 2){
						arrinferior[cont] = matriz5[i][j];
						cont++;
					}
				}
				cont = 0;
			...
			for (int i = 0; i < 3; ++i){
				for (int j = 0; j < 3; ++j){
					if(j == 0){
						matriz5[i][j] = arrinferior[cont];
						cont++;
					}
					else if(j == 1){
						matriz5[i][j] = arrmedio[cont];
						cont++;
					}
					else if(j == 2){
						matriz5[i][j] = arrsuperior[cont];
						cont++;
					}
			...
			for (int h = 0; h <= 4; ++h){
				for (int i = 0; i < 3; ++i){
					for (int j = 0; j < 3; ++j){
						if(h == 1){
							if(j == 0){
								matriz2[i][j] = arrabajo[cont];
								cont++;
							}
						}
						else if(h == 2){
							if(i == 0){
								matriz4[i][j] = arrfrente[cont];
								cont++;
							}
						}
						else if(h == 3){
							if(j == 2){
								matriz1[i][j] = arrarriba[cont];
								cont++;
							}
						}
						else if(h == 4){
							if(i == 2){
								matriz3[i][j] = arratras[cont];
								cont++;
							}
						}
					}
		...
		if(opcion == 11){
			...
			for (int i = 0; i < 3; ++i){
				for (int j = 0; j < 3; ++j){
					if(i == 0){
						arrsuperior[cont] = matriz6[i][j];
						cont++;
					}
					else if(i == 1){
						arrmedio[cont] = matriz6[i][j];
						cont++;
					}
					else if(i == 2){
						arrinferior[cont] = matriz6[i][j];
						cont++;
					}
				}
				cont = 0;
			...
			for (int i = 0; i < 3; ++i){
				for (int j = 0; j < 3; ++j){
					if(j == 0){
						matriz6[i][j] = arrinferior[cont];
						cont++;
					}
					else if(j == 1){
						matriz6[i][j] = arrmedio[cont];
						cont++;
					}
					else if(j == 2){
						matriz6[i][j] = arrsuperior[cont];
						cont++;
					}
		...
		if(opcion == 13){
			...
			cout << "La opcion random elegida fue el numero: " << randnum << endl;
